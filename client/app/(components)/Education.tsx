...
export default function TrainingSection() {
  return (
    <section className="bg-white py-12 px-6 scroll-mt-20" id="education">
      <h2
        className="text-3xl font-extrabold text-gray-700 mb-6 text-center"
        style={{ textShadow: "0px 4px 10px rgba(0,0,0,0.7)" }}
      >
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <ul className="list-disc list-inside space-y-4 text-lg text-gray-700">
            ...
            <li data-category="honors">
              <strong>Specialization</strong> in Query Optimization using NLP in
              DDBMS
            </li>
